...
class Alignment:
    ...
    def compute_all_subsequences(self, subseq_len: int, shift: int):
        ...
        while (index <= seq_len - subseq_len):
            ...
            subseq = Subsequence(value=subseq_value, alignment_id=self.id,
                                 position=index, alignment_position_in_genome=self.position_in_genome)
        ...
        if index < seq_len:
            ...
            subseq = Subsequence(value=subseq_value, alignment_id=self.id, position=seq_len -
                                 subseq_len, alignment_position_in_genome=self.position_in_genome)
            subseq_list.append(subseq)
